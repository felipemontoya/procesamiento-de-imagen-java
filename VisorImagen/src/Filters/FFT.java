...
public class FFT{
   ...
   */
  public ComplexArray intermediate;
  /**
   * Data structure to hold the ouput of the algorithm.
   */
  public ComplexArray output;
	public int progress;
  /**
  ...
  public FFT(int [] pixels, int w, int h){
	progress = 0;
	  input = new ComplexArray(pixels,w,h);
    intermediate = new ComplexArray(pixels,w,h);
    output = new ComplexArray(pixels,w,h);
    transform();
  }
