...
public class InverseFFT{
   ...
   */
  public ComplexArray transform(ComplexArray input){
	progress = 0;
    ComplexArray intermediate = new ComplexArray(input.width, input.height);
    ComplexArray output = new ComplexArray(input.width, input.height);
  ...
  public int[] getPixels(ComplexArray output) {
