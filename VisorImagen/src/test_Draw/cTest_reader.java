 ...
 *
 */
public class cTest_reader {
    //datos de la imagen en la clase
    private cTest_ImageData readImage;
    ...
    public cTest_reader(File currentFile){
        ...
        buffer = new byte[10 * 1024];
            ...
            if (HeaderFormatRight()){
                this.readImage = new cTest_ImageData(width, height, origen, nChanels, 1, alineacion, spaceColor);
                FillImagenData();
            }
            else{
    ...
    private boolean HeaderFormatRight(){
        ...
        origen = cTest_ImageData.ARRIBA_IZQ;
        ...
        spaceColor = cTest_ImageData.RGBA;

        alineacion = cTest_ImageData.ALINEADO_4;
    ...
    //retorna la imagen
    public cTest_ImageData getImagenData(){
